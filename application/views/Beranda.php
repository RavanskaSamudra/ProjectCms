        ...
        <div class="header-carousel owl-carousel">
            ...
            foreach ($caraousel as $caro) { ?>
                <div class="header-carousel-item">
                    <img src="<?= base_url('assets/upload/carousel/' . $caro['foto']) ?>" class="img-fluid w-100" alt="<?= $caro['judul'] ?>">
                </div>
            <?php $no++;
            } ?>
        </div>
                ...
                <?php foreach ($konten as $ktn) { ?>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="<?= base_url('assets/upload/konten/' . $ktn['foto']) ?>" class="img-fluid" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                    <a href="#" class="text-muted"><span class="fa fa-comments text-primary"></span><?= $ktn['nama'] ?></a>
                                    <a href="#" class="text-muted"><span class="fa fa-comments text-primary"></span><?= $ktn['nama_kategori'] ?></a>
                                </div>
                                <a href="<?= base_url('beranda/artikel/' . $ktn['slug']) ?>" class="h4"><?= word_limiter($ktn['judul'], 3) ?></a>
                                <span class="d-block text-truncate" style="max-width: 150px;">
                                    <?= $ktn['keterangan'] ?>
                                </span>
                                <a href="<?= base_url('beranda/artikel/' . $ktn['slug']) ?>" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Read More</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        <h4 class="text-white mb-4"><i class="fas fa-tshirt"></i></i><?= $konfig->judul_website ?></h4>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="https://maps.app.goo.gl/91oiXE8B9obDtcAi8"><i class="fa fa-map-marker-alt me-2"></i> <?= $konfig->alamat ?></a>
                    </div>
                </div>
            </div>
        </div>
